...
export default class Kag7 extends React.Component {
  ...
  handleButtonPress=()=> {
    ...
    let diceroll6S7 = Math.floor(Math.random() * 8) + 1 ;
    let diceroll6S8 = Math.floor(Math.random() * 8) + 1 ;
    let TotalS1 = diceroll6S1 + 12;
    let TotalS2 = diceroll6S2 + 12;
    let TotalS3 = diceroll6S3 + 9;
    let TotalS4 = diceroll6S4 + 9;
    let TotalS5 = diceroll6S5 + 18;
    let TotalS6 = diceroll6S5 + 18;
    let TotalS7 = diceroll6S7 + 13;
    let TotalS8 = diceroll6S8 + 13;
  ...
  render() {
    ...
    return (
      <ImageBackground source={require('../images/Kagb.jpg')} style={styles.container}>
