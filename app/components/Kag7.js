...
export default class Kag7 extends React.Component {
  ...
  handleButtonPress=()=> {
    ...
    let diceroll6S7 = Math.floor(Math.random() * 6) + 1 ;
    let diceroll6S8 = Math.floor(Math.random() * 6) + 1 ;
    let TotalS1 = diceroll6S1 + 11;
    let TotalS2 = diceroll6S2 + 11;
    let TotalS3 = diceroll6S3 + 8;
    let TotalS4 = diceroll6S4 + 8;
    let TotalS5 = diceroll6S5 + 17;
    let TotalS6 = diceroll6S5 + 17;
    let TotalS7 = diceroll6S7 + 12;
    let TotalS8 = diceroll6S8 + 12;
  ...
  this.setState({
    ...
    NumberHolderD6S7 : diceroll6S7,
    NumberHolderD6S8 : diceroll6S8,
  ...
  render() {
    ...
    return (
      <ImageBackground source={require('../images/efreeti7.jpg')} style={styles.container}>
